...
Помимо проекта с заданием был сделан проект для тестирования с шестью тестами, в каждом из которых на вход программа получает разное количество
значений, результат действия которых сравнивается с ожидаемыми данными, которые хранятся в DataForTests.
